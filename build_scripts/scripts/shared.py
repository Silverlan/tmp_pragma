...
def run_cmake_script(fileName):
	...
	subprocess.run([config.cmake_path, "-DTOOLSET=" +config.toolset, "-DCMAKE_SOURCE_DIR=" +config.pragma_root, "-DPRAGMA_DEPS_DIR=" +config.prebuilt_bin_dir, "-P", fileName],check=True)
